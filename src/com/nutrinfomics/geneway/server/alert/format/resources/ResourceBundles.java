package com.nutrinfomics.geneway.server.alert.format.resources;
...
public class ResourceBundles {
	private final static String PATH = "com/nutrinfomics/geneway/client/constants/";
	...
	public static String getOpeningHoursResource(String string, Locale locale) {
		return ResourceBundle.getBundle("OpeningHours", locale).getString(string);
	}

	public static String getCongratulationsResource(String string, Locale locale) {
		return ResourceBundle.getBundle("Congratulations", locale).getString(string);
	}
