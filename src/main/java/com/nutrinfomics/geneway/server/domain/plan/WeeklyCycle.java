...
public class WeeklyCycle extends ArbitraryCycle{
	...
	@Transient
	private List<WeeklyBehaving> weeklyBehavings = new Vector<>();
...
//			TypedQuery<WeeklyCycle> query = entityManager.createQuery("SELECT s FROM WeeklyCycle", WeeklyCycle.class);
//			try{
